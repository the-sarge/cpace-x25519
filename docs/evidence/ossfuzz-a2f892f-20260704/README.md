...
- `build-fuzzers-address-x86_64.log`: clean address-sanitizer fuzzer build transcript.
- `check-build-address-x86_64.log`: OSS-Fuzz `check_build` transcript.
