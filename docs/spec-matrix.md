...
| Compute ISK from `lv_cat(DSI_ISK,sid,K)||transcript_ir(...)` | `deriveISK` | `TestX25519Draft21Vectors`; embedded X25519/SHA-512 JSON fixture pinned to the draft-decoded SHA-256 |
